              ...
              <div class="card-body">
                <form onSubmit={(e) => forgetPassword(e)}>
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="email" placeholder='Enter your email' value={ForgetPassword.email} onChange={(e) => setForgetPassword({ ...ForgetPassword, email: e.target.value })} />
                    <label ref={emailref} className='errmsg'></label>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary p-2 text-dark mt-2 button text-white">Sent Email</button><br />
